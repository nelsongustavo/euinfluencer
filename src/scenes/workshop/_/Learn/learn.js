    ...
    <div className="learn">
      ...
      <Row className="show-grid">
        <Col xs={12} md={6}>
          <div className="item">
            <span className="ico">
              <img src="https://firebasestorage.googleapis.com/v0/b/euinfluencer.appspot.com/o/bar-chart%20(1).png?alt=media&token=5452691f-dfd8-4322-a9f7-aed4d9dc2c86"></img>
            </span>
        ...
        <Col xs={12} md={6}>
          <div className="item">
            <span className="ico">
              <img src="https://firebasestorage.googleapis.com/v0/b/euinfluencer.appspot.com/o/brainstorm.png?alt=media&token=873e6971-2066-4600-80b6-d91c6547ca5d"></img>
            </span>
      ...
      <Row className="show-grid">
        <Col xs={12} md={6}>
          <div className="item">
            <span className="ico">
              <img src="https://firebasestorage.googleapis.com/v0/b/euinfluencer.appspot.com/o/handshake.png?alt=media&token=74ae6c05-4c30-4e20-bc9f-0c8312796f1d"></img>
				    </span>
        ...
        <Col xs={12} md={6}>
          <div className="item">
            <span className="ico">
              <img src="https://firebasestorage.googleapis.com/v0/b/euinfluencer.appspot.com/o/question.png?alt=media&token=602c592e-5519-431f-9de7-865bc228a949"></img>
            </span>
            <h3>TIRA DÚVIDAS</h3>
